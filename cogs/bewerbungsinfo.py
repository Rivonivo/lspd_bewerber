...
class bewerbungsinfo(commands.Cog):
    ...
    @discord.slash_command(integration_types={discord.IntegrationType.user_install}, name="bewerbungsinfo", description="Sende die Bewerbungsinfo")
    async def _fragenueberfragen(self, ctx: discord.ApplicationContext):
...
def setup(bot):
    bot.add_cog(bewerbungsinfo(bot))
